...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7236087168:AAEdbULW8maay0W6rbDhzSkhEQysFXdc6ZY'
ADMIN_USER_ID = 6329099426  # Replace with your admin user ID
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to mastbelaa DDOS world 🔥*\n\n"
